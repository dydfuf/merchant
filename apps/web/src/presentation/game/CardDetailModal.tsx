    ...
    >
      <BaseDialog.Portal>
        ...
        <div className={styles.overlayViewport}>
          <BaseDialog.Popup aria-labelledby="card-detail-title" className={styles.cardDetailDialog}>
            <header className={styles.cardDetailHeader}>
              <span>자산 상세</span>
              <BaseDialog.Close type="button">×</BaseDialog.Close>
            </header>
            ...
            <div className={styles.cardDetailBody}>
              ...
              <section className={styles.costSection}>
                <div className={styles.costSectionHeader}>
                  <BaseDialog.Title id="card-detail-title">획득 비용</BaseDialog.Title>
